...
for color in collected_colors:
    if color in main_colors:
        continue
    required_color_1, required_color_2 = secondary_required_colors[color]
    if not (required_color_1 in collected_colors) or not (required_color_2 in collected_colors):
